...
;; deployed on mainnet at SP3XXMS38VTAWTVPE5682XSBFXPTH7XCPEBTX8AN2.buy-with-velar-faktory

(use-trait faktory-dex .faktory-dex-trait-v1.dex-trait) ;; 'SP3XXMS38VTAWTVPE5682XSBFXPTH7XCPEBTX8AN2
(use-trait faktory-token .faktory-trait-v1.sip-010-trait) ;; 'SP3XXMS38VTAWTVPE5682XSBFXPTH7XCPEBTX8AN2
(use-trait ft-trait .sip-010-trait-ft-standard.sip-010-trait) ;; 'SP2AKWJYC7BNY18W1XXKPGP0YVEK63QJG4793Z2D4
...
(define-constant PEPE-TOKEN .tokensoft-token-v4k68639zxz) ;; 'SP1Z92MPDQEWZXW36VX71Q25HKF5K2EPCJ304F275
...
(define-constant WSTX-TOKEN .wstx) ;; 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1
(define-constant SHARE-FEE-TO .univ2-share-fee-to) ;; 'SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1
...
;; SP1Y5YSTAHZ88XYK1VPDH24GY0HPX5J4JECTMY4A1.wstx-pepe
...
(define-public (buy
    ...
    (ft <faktory-token>))
        ...
        ;; Execute Velar swap ;; 'SP20X3DC5R091J8B6YPQT638J8NR1W83KN6TN5BJY.path-apply_staging
        (let ((swap-result 
            (try! (contract-call? 
                .path-apply_staging 
                apply
